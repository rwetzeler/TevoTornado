...
#define STRING_CONFIG_H_AUTHOR "Rob Wetzeler" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Marlin 1.1.9 ACOL" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "TMC2208, LV8729, BLTouch, Bondtech QR"         // will be shown during bootup in line 2
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
 ...
 // #define DEFAULT_Kp 22.2
  ...
  // Tevo Tornado
  #define DEFAULT_Kp 70.81
  #define DEFAULT_Ki 11.68
  #define DEFAULT_Kd 107.31
